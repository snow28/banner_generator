$(document).ready(function() {
    ...
    //parse link from url to which banner should link
    ...
    // we will use this function to recursively animate long legal note
    // when text fill more space then available, we can animate it like a line,
    //so it will go from the left to the right, and when reach end point, everything restarts
